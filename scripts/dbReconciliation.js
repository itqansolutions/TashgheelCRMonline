...
const reconcileDatabase = async () => {
    ...
    try {
        ...
        try {
            ...
            await db.query(`ALTER TABLE deals ADD COLUMN IF NOT EXISTS source_type VARCHAR(50) NULL`);
            await db.query(`ALTER TABLE deals ADD COLUMN IF NOT EXISTS source_id VARCHAR(255) NULL`);
